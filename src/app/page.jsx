    ...
    <div className="bg-[#fbfaeb] text-[#1b1c13] font-sans overflow-x-hidden">
      <main className="max-w-360 mx-auto px-4 sm:px-6 md:px-10 py-5">
            ...
            >
              ...
              <div className="relative mt-8 overflow-hidden rounded-4xl">
                <img
                  ...
                  className="h-112.5 w-full object-cover transition-transform duration-700 group-hover:scale-105"
                />
              </div>
            </Link>
            ...
            >
              ...
              <div className="relative mt-8 overflow-hidden rounded-4xl">
                <img
                  src={fruitimage.src}
                  alt="Fruit Powders"
                  className="h-112.5 w-full object-top transition-transform duration-700 group-hover:scale-105"
                />
              </div>
            </Link>
          </div>
        ...
        <section className="text-center mb-16">
          <span className="text-xs tracking-widest font-bold text-[#7e5700] mb-4 inline bg-black/10 px-5 py-2 rounded-4xl">
            OUR PHILOSOPHY
          </span>
